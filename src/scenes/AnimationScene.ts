...
//     console.log("Before initializing scene");
//     this.initializeScene();
//     console.log("After initializing scene");
...
//     try {
//       console.log("Starting to load assets JSON1");
...
//       console.log("before jsonManager.handleAssetsJson");
...
//         });
//       }
//       console.log("before this.jsonManager.handleTimelineJson");
